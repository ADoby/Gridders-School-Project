...
public class FreeLookCam : AbstractTargetFollower
{
	...
	protected override void FollowTarget (float deltaTime)
	{
		...
		//transform.position = Vector3.Lerp(transform.position, target.position + currentRotation * (Vector3.right * 1.5f), deltaTime * moveSpeed);
	...
	void HandleRotationMovement()
	{
		...
		//currentRotation = Quaternion.Euler (0f, lookAngle, 0f);
